...
/// Script modified from Camerawork Script Photon Unity Networking Basic Tutorial Part 6
/// </summary>
public class CameraManager : MonoBehaviour
{
    [Tooltip("Mouse ScrollWheel Zoom Speed")]
    ...
    public float heightSmoothLag = 0f;
    ...
    void LateUpdate()
    {
        ...
        {
            // scroll up
            myCamera.orthographicSize = myCamera.orthographicSize + (ZoomSpeed*d);
        }
        else if (d < 0f)
        {
            // scroll down
